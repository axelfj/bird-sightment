...
<script>
    ...
    function cambiaEspecie(obj,oCntrl){
        ...
        genero = parseInt(val);
        if(genero == 0){
            document.getElementById("mthid").value = null;
        } else {
            document.getElementById("mthid").value = genero;
        }
        while (oCntrl.length) oCntrl.remove(0);
        switch (parseInt(val)){
...
<div class="w3-top">
    <div class="w3-bar w3-theme-d4 w3-left-align w3-large" style="background-color: #9d9d9d">
        ...
        <a href="#" class="w3-center w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white w3-theme-d1" title="Add specie"><i class="fa fa-plus-square"></i> Specie</a>
        ...
        <div class="w3-col m2">
            ...
            <div class="login">
                <form name="frm">
                    ...
                    <h6></h6>
                    <select class="w3-grey btn-large" name="specie" style="position: absolute; top: 0%;left: 367%">
            ...
            <div class="login2">
                <form name="frm2"  action="php/addAnml.php" method="post" enctype="multipart/form-data">
                    <input hidden type="number" name="type" value="6" placeholder="Especie" required="required"/>
                    <input hidden id="mthid" type="number" name="gender" placeholder="Especie" required="required"/>
                    <input type="text" name="scientific" placeholder="Scientific name" required="required" />
                    <input type="text" name="specie" placeholder="Name" required="required" />
                    <input type="text" name="spanish" placeholder="Spanish name" required="required" />
                    <input type="text" name="english" placeholder="English name" required="required" />
                    <input type="text" name="color" placeholder="Color" required="required" />
                    <input type="number" name="size" step="0.000001" placeholder="Size in cm" required="required"/>
                    <select class="w3-theme-d1 btn-block btn-large" name="danger" required="required">
                        <option value="0">Sin peligro de extincion</option>
                        <option value="1">Con peligro de extincion</option>
                    </select>
                    <h6></h6>
