...
<script>
    ...
    function cambiaFamilia(obj,oCntrl){
        ...
        if(suborden == 0){
            ...
            document.getElementById("mthid").value = suborden;
        }
        while (oCntrl.length) oCntrl.remove(0);
        switch (parseInt(val)){
...
<div class="w3-top">
    <div class="w3-bar w3-theme-d4 w3-left-align w3-large" style="background-color: #9d9d9d">
        ...
        <a href="#" class="w3-center w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white w3-theme-d1" title="Add family"><i class="fa fa-plus-square"></i> Family</a>
        ...
        <div class="w3-col m2">
            ...
            <div class="login">
                <form name="frm">
                    ...
                    <h6></h6>
                    <select class="w3-grey btn-large" name="family" style="position: absolute; top: 0%;left: 367%">
            ...
            <div class="login2">
                <form name="frm2"  action="php/addAnml.php" method="post" enctype="multipart/form-data">
                    <input hidden type="text" name="type" value="4" placeholder="Name" required="required" />
                    <input type="text" id="mthid" name="motherid" placeholder="motherid" required="required" />
