...
CREATE OR REPLACE TRIGGER beforeInsertAMATEUR
BEFORE INSERT
ON AMATEUR
FOR EACH ROW
BEGIN
    INSERT INTO ACTION_HISTORY(ACTION_DATE, ACTION_ID, ACTION_NAME, TABLE_NAME, USER_NAME)
        VALUES(SYSDATE, SEQ_ACTION.NEXTVAL, 'INSERT', 'AMATEUR', USER);
    :NEW.DATE_CREATION:=SYSDATE;
    :NEW.USER_CREATION:=USER;
END beforeInsertAMATEUR;
/
CREATE OR REPLACE TRIGGER beforeUpdateAMATEUR
BEFORE UPDATE
ON AMATEUR
FOR EACH ROW
BEGIN
    INSERT INTO ACTION_HISTORY(ACTION_DATE, ACTION_ID, ACTION_NAME, TABLE_NAME, USER_NAME)
        VALUES(SYSDATE, SEQ_ACTION.NEXTVAL, 'UPDATE', 'AMATEUR', USER);
    :NEW.DATE_MODIFICATION:=SYSDATE;
    :NEW.USER_MODIFICATION:=USER;
END beforeUpdateEMPLOYEE; 
/
CREATE OR REPLACE TRIGGER beforeDeleteAMATEUR
BEFORE DELETE
ON AMATEUR
FOR EACH ROW
BEGIN
    INSERT INTO ACTION_HISTORY(ACTION_DATE, ACTION_ID, ACTION_NAME, TABLE_NAME, USER_NAME)
        VALUES(SYSDATE, SEQ_ACTION.NEXTVAL, 'DELETE', 'AMATEUR', USER);
END beforeDeleteAMATEUR;
/
...
/
CREATE OR REPLACE TRIGGER beforeInsertORNITHOLOGIST
BEFORE INSERT
ON ORNITHOLOGIST
FOR EACH ROW
BEGIN
    INSERT INTO ACTION_HISTORY(ACTION_DATE, ACTION_ID, ACTION_NAME, TABLE_NAME, USER_NAME)
        VALUES(SYSDATE, SEQ_ACTION.NEXTVAL, 'INSERT', 'ORNITHOLOGIST', USER);
    :NEW.DATE_CREATION:=SYSDATE;
    :NEW.USER_CREATION:=USER;
END beforeInsertORNITHOLOGIST;
/
CREATE OR REPLACE TRIGGER beforeUpdateORNITHOLOGIST
BEFORE UPDATE
ON ORNITHOLOGIST
FOR EACH ROW
BEGIN
    INSERT INTO ACTION_HISTORY(ACTION_DATE, ACTION_ID, ACTION_NAME, TABLE_NAME, USER_NAME)
        VALUES(SYSDATE, SEQ_ACTION.NEXTVAL, 'UPDATE', 'ORNITHOLOGIST', USER);
    :NEW.DATE_MODIFICATION:=SYSDATE;
    :NEW.USER_MODIFICATION:=USER;
END beforeUpdateORNITHOLOGIST; 
/
CREATE OR REPLACE TRIGGER beforeDeleteORNITHOLOGIST
BEFORE DELETE
ON ORNITHOLOGIST
FOR EACH ROW
BEGIN
    INSERT INTO ACTION_HISTORY(ACTION_DATE, ACTION_ID, ACTION_NAME, TABLE_NAME, USER_NAME)
        VALUES(SYSDATE, SEQ_ACTION.NEXTVAL, 'DELETE', 'ORNITHOLOGIST', USER);
END beforeDeleteORNITHOLOGIST;
/
